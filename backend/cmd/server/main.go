...
func main() {
	...
	api := r.Group("/api", handlers.JWTMiddleware())
	{
		...
		api.GET("/workbench/stories/:id", handlers.GetStory)
		...
		api.POST("/zentao/stories", handlers.CreateZentaoStory)
		api.PATCH("/zentao/stories/:id", handlers.UpdateZentaoStory)
		api.DELETE("/zentao/stories/:id", handlers.DeleteZentaoStory)
